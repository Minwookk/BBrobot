...
"""autogenerated by genpy from mmdetection_ros/mmdetSrvRequest.msg. Do not edit."""
import codecs
import sys
...
class mmdetSrvRequest(genpy.Message):
  _md5sum = "b13d2865c5af2a64e6e30ab1b56e1dd5"
  _type = "mmdetection_ros/mmdetSrvRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mmdetSrvRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from mmdetection_ros/mmdetSrvResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class mmdetSrvResponse(genpy.Message):
  _md5sum = "5cf8ff1e509acd20d36134d832fd1ba9"
  _type = "mmdetection_ros/mmdetSrvResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vision_msgs/Detection2DArray results
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mmdetSrvResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.results is None:
        self.results = vision_msgs.msg.Detection2DArray()
    else:
      self.results = vision_msgs.msg.Detection2DArray()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.results.detections)
      buff.write(_struct_I.pack(length))
      for val1 in self.results.detections:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.results.detections.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
def _get_struct_qd():
    ...
    return _struct_qd
class mmdetSrv(object):
  _type          = 'mmdetection_ros/mmdetSrv'
  _md5sum = '2cc7b49d11a2a746a7bb9d18f1509c53'
  _request_class  = mmdetSrvRequest
  _response_class = mmdetSrvResponse
